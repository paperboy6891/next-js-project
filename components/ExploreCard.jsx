...
const ExploreCard = ({ id, imgUrl, title, handleClick, index, active }) => (
  <motion.div
    variants={fadeIn('right', 'spring', index * 0.5, 0.75)}
    className={`relative ${active === id ? 'lg:flex-[3.5] flex[10]'
      : 'lg:flex[0.5] flex-[2]'} flex items-center justify-center min-w-[170px] h-[700px]
    ...
    {active !== id ? (
      ...
      : (
        <div className="absolute bottom-0 p-8 justify-start w-full flex-col
          bg-[rgba(0,0,0,0.6)] rounded-b-[24px]"
        >
          <div className={`${styles.flexCenter} w-[60px] h-[60px] rounded-[20px]
